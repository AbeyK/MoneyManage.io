  ...
  var App = exports.App = (_dec = (0, _aureliaFramework.inject)(_user.User), _dec(_class = function () {
    ...
    App.prototype.attached = function attached() {
      ...
      firebase.auth().onAuthStateChanged(function (user) {
        if (user) _this.signedIn = true;else _this.signedIn = false;
      });
    };
...
define('text!login/login.html', ['module'], function(module) { module.exports = "<template><require from=\"login/login.css\"></require><require from=\"home/home.css\"></require><form submit.delegate=\"login(emailInput, passwordInput)\" action=\"#\" id=\"login-form\"><div class=\"heading\">MoneyManage</div><div class=\"left\"><label for=\"email\">Email</label><br><input value.bind=\"emailInput\" type=\"email\" name=\"email\" id=\"email\" placeholder=\"email@email.com\"><br><label for=\"password\">Password</label><br><input value.bind=\"passwordInput\" type=\"password\" name=\"password\" id=\"pass\" placeholder=\"password\"><br><input type=\"submit\" value=\"Login\"></div><div class=\"right\"><div class=\"connect\">Connect with</div><a href=\"\" class=\"facebook\" click.delegate=\"facebookLogin()\"><span class=\"fontawesome-facebook\">Facebook</span></a><br><a href=\"\" class=\"twitter\"><span class=\"fontawesome-twitter\" click.delegate=\"twitterLogin()\">Twitter</span></a><br><a href=\"\" class=\"google-plus\"><span class=\"fontawesome-google-plus\" click.delegate=\"googleLogin()\">Google</span></a></div></form><form submit.delegate=\"newUser(newEmail, newPassword)\" id=\"login-form\"><div class=\"heading\">Create new user</div><div class=\"left\"><label for=\"email\">Email</label><br><input value.bind=\"newEmail\" type=\"email\" name=\"email\" id=\"email\" placeholder=\"email@email.com\"><br><label for=\"password\">Password</label><br><input value.bind=\"newPassword\" type=\"password\" name=\"password\" id=\"pass\" placeholder=\"password\"><br><input type=\"submit\" value=\"New User\"></div><div class=\"right\"><div class=\"connect\">Connect with</div><a href=\"\" class=\"facebook\"><span class=\"fontawesome-facebook\" click.delegate=\"facebookLogin()\">Facebook</span></a><br><a href=\"\" class=\"twitter\"><span class=\"fontawesome-twitter\" click.delegate=\"twitterLogin()\">Twitter</span></a><br><a href=\"\" class=\"google-plus\"><span class=\"fontawesome-google-plus\" click.delegate=\"googleLogin()\">Google</span></a></div></form></template>"; });
...
define('text!results/results.html', ['module'], function(module) { module.exports = "<template><div id=\"results\"><br><br><compose view-model=\"./compose/compose-chart\"></compose><compose view-model=\"./compose/compose-recommendations\"></compose><compose view-model=\"./compose/compose-table\"></compose><hr><button class=\"btn btn-secondary btn-lg\" style=\"float:left;width:10vmax;margin:1vw\" click.delegate=\"back()\"><span class=\"glyphicon glyphicon-arrow-left\"></span></button> <button class=\"btn btn-lg\" style=\"float:center;width:20vmax;background-color:#dff0d8\" click.delegate=\"getChartData()\">Redraw Chart</button> <button class=\"btn btn-primary btn-lg\" style=\"float:right;width:10vmax;margin:1vw\" click.delegate=\"home()\">Finish</button><br><br><br></div></template>"; });
...
define('text!expenses/compose/compose-home-expenses.html', ['module'], function(module) { module.exports = "<template><br><div class=\"${click ? 'none' : 'box-shadow--6dp'}\" style=\"border-radius:0\"><div><h4 class=\"panel-title\"><div style=\"float:right;padding:5px;width:30%;text-align:right\">Yearly Total: $${user.expenses.totalHomeExpense.toFixed(2)}</div><a data-toggle=\"collapse\" data-parent=\"#accordion\" href=\"#homeExpenseCollapse\" click.delegate=\"clicked()\" style=\"float:left;padding:5px;width:30%\"><span show.bind=\"click\" class=\"glyphicon glyphicon-chevron-right\"></span> <span show.bind=\"!click\" class=\"glyphicon glyphicon-chevron-down\"></span> </a><a data-toggle=\"collapse\" data-parent=\"#accordion\" href=\"#homeExpenseCollapse\" click.delegate=\"clicked()\" style=\"font-size:24px\"><center>Home <span id=\"expensesTooltip\" title=\"\" class=\"glyphicon glyphicon-question-sign\"></span></center></a></h4></div><div id=\"homeExpenseCollapse\" class=\"panel-collapse collapse in\"><div class=\"panel-body\"><div repeat.for=\"home of constants.HomeExpenses\" class=\"form-group col-md-6\"><label style=\"padding-left:5%\">${home.title}</label><div class=\"input-group mb-2 mr-sm-2 mb-sm-0 expensesInput\"><div class=\"input-group-addon\">$</div><input type=\"text\" value.bind=\"user.expenses[home.value]\" change.delegate=\"calculateExpenses.homeExpenses()\" class=\"form-control\" id=\"${home.value}\"><div class=\"input-group-btn\"><button type=\"button\" class=\"btn ${user.expenses[home.value + 'lock'] ? 'btn-default' : 'btn-primary'}\" click.delegate=\"lockStateChange(home.value)\"><i class=\"fa fa-unlock\" show.bind=\"!user.expenses[home.value + 'lock']\"></i> <i class=\"fa fa-lock\" show.bind=\"user.expenses[home.value + 'lock']\"></i></button></div></div><br></div></div></div></div></template>"; });
define('text!results/compose/compose-chart.html', ['module'], function(module) { module.exports = "<template><div class=\"col-md-6\"><div class=\"box-shadow--6dp\" show.bind=\"user.results.showBudget\" id=\"resultsContainerSimple\"></div><div class=\"box-shadow--6dp\" show.bind=\"user.results.showAdvanced\" id=\"resultsContainerAdvanced\"></div><div class=\"box-shadow--6dp\" show.bind=\"user.results.showGoalsChart\" id=\"fiveYearGoalsContainer\"></div><div class=\"box-shadow--6dp\" show.bind=\"user.results.showExpenses\" id=\"fiveYearExpensesContainer\"></div><div class=\"form-group\" style=\"padding-top:3vmin\"><label for=\"charts\">Chart Options</label><select class=\"form-control\" value.bind=\"option\" change.delegate=\"showChart(option)\"><option repeat.for=\"option of chartOptions\">${option.text}</option></select></div></div><div class=\"col-md-6\"><div class=\"box-shadow--6dp\" show.bind=\"!user.results.showAdvancedRecommended\" id=\"recommendedContainer\"></div><div class=\"box-shadow--6dp\" show.bind=\"user.results.showAdvancedRecommended\" id=\"recommendedContainerAdvanced\"></div><div class=\"form-group\" style=\"padding-top:3vmin\"><label for=\"recommended\">Recommended Chart Options</label><select class=\"form-control\" value.bind=\"option\" change.delegate=\"showRecommendedChart(option)\"><option>Recommended Simple Budget</option><option>Recommended Advanced Budget</option></select></div></div><br><br></template>"; });
