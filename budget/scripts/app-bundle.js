                ...
                for (var i = 0; i < this.constants.HomeExpenses.length; i++) {
                    ...
                    if (!this.user.recommend[expenseName + 'lock']) ;else {
                        if (expenseName == 'phone') {
                            ...
                            if (this.user.recommend['cable'] == 0 && this.user.recommend.homeChanges['cable'] > 0 && count == 4) adjusted = this.user.expenses.homeExpenseConstants.Streaming;else adjusted = this.user.recommend[expenseName];
...
>>>>>>> 2314ccb05d5d38359894f10e2c434ccdc6ff2af6
