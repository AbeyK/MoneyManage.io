...
define('text!aboutyou/personalinfo.html', ['module'], function(module) { module.exports = "<template><div id=\"personalinfo\"><form submit.delegate=\"next()\"><compose view-model=\"./compose/compose-personal-info\"></compose><br><br><compose view-model=\"./compose/compose-goals\"></compose><hr><button class=\"btn btn-secondary btn-lg\" style=\"float:left;width:10%\" click.delegate=\"back()\"><span class=\"glyphicon glyphicon-arrow-left\"></span></button> <button class=\"btn btn-primary btn-lg\" style=\"float:right;width:10%\" type=\"submit\" id=\"next\"><span class=\"glyphicon glyphicon-arrow-right\"></span></button></form><br><br><br></div></template>"; });
...
define('text!expenses/expenses.html', ['module'], function(module) { module.exports = "<template><link rel=\"stylesheet\" href=\"https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css\"><div id=\"expenses\"><h2>Expenses <span id=\"expensesTooltip\" title=\"\" class=\"glyphicon glyphicon-question-sign\"></span></h2></div><form submit.delegate=\"next()\"><div class=\"container\" style=\"width:60%;padding:0\"><div class=\"panel-group\" id=\"accordion\"><compose view-model=\"./compose/compose-home-expenses\"></compose><compose view-model=\"./compose/compose-car-expenses\"></compose><compose view-model=\"./compose/compose-health-expenses\"></compose><compose view-model=\"./compose/compose-discretionary-expenses\"></compose></div></div><div id=\"expenses\"><hr><button class=\"btn btn-secondary btn-lg\" style=\"float:left;width:10%\" click.delegate=\"back()\"><span class=\"glyphicon glyphicon-arrow-left\"></span></button> <button class=\"btn btn-primary btn-lg\" style=\"float:right;width:10%\" type=\"submit\" id=\"next\"><span class=\"glyphicon glyphicon-arrow-right\"></span></button></div></form></template>"; });
