...
define('about/about',['exports', 'aurelia-framework', 'aurelia-router', '../services/user', 'bootbox'], function (exports, _aureliaFramework, _aureliaRouter, _user, bootbox) {
    'use strict';
    ...
    var about = exports.about = (_dec = (0, _aureliaFramework.inject)(_aureliaRouter.Router, _user.User), _dec(_class = function () {
        ...
        about.prototype.start = function start() {
            var _this = this;
...
define('aboutyou/personalinfo',['exports', 'aurelia-framework', 'aurelia-router', '../services/user', '../services/constants', '../utilities/slider', '../services/expensesConstants', 'bootbox'], function (exports, _aureliaFramework, _aureliaRouter, _user, _constants, _slider, _expensesConstants, bootbox) {
    'use strict';
    ...
    var personalinfo = exports.personalinfo = (_dec = (0, _aureliaFramework.inject)(_aureliaRouter.Router, _user.User, _slider.Slider, _constants.Constants, _expensesConstants.ExpensesConstants), _dec(_class = function () {
        ...
        personalinfo.prototype.next = function next() {
            ...
            if (!this.checkRanks) alert('Enter valid ranks');else if (this.user.personalInfo.income < 0 || isNaN(this.user.personalInfo.income)) {
                bootbox.alert({
                    title: "MoneyManage",
...
define('text!aboutyou/personalinfo.html', ['module'], function(module) { module.exports = "<template><div id=\"personalinfo\"><form submit.delegate=\"next()\"><compose view-model=\"./compose/compose-personal-info\"></compose><br><br><compose show.bind=\"user.personalInfo.widthGreaterThan800\" view-model=\"./compose/compose-goals\"></compose><br><hr><button class=\"btn btn-default btn-lg\" style=\"float:left;width:10vmax;margin:1vw\" click.delegate=\"back()\"><span class=\"glyphicon glyphicon-arrow-left\"></span></button> <button class=\"btn btn-primary btn-lg\" style=\"float:right;width:10vmax;margin:1vw\" type=\"submit\" id=\"next\"><span class=\"glyphicon glyphicon-arrow-right\"></span></button></form></div><br><br><br></template>"; });
define('text!css/drag-and-drop.css', ['module'], function(module) { module.exports = ".goalOverflow {\n    overflow-y:scroll;\n}\n\n#myGoals {\n    width: 100%; \n    height: 30%; \n    background-color: #f5f5f5;\n    text-align: center; \n    color: #337ab7;\n    vertical-align: middle; \n    line-height: 150px;\n}\npanel{\n    height: 10px !important;\n        box-shadow: 10px 10px grey;\n\n}\n"; });
define('text!about/about.html', ['module'], function(module) { module.exports = "<template><require from=\"css/style.css\"></require><require from=\"home/home.css\"></require><br><br><br><nav id=\"personalinfo\"><div><h3 style=\"color:#337ab7;font-size:1.3em;width:90%;text-align:justify;margin:0 auto;line-height:1.6em\">The MoneyManage Budget Planner helps you manage your income in an intuitive and fun way. Effortlessly stay on top of finances and see your plan’s progress with SmartGraphs. Find opportunities to save with SpendAlerts and see how much you’re spending compared to the rest of the country. With our goal based approach, we help you create a plan with a vision for the future in mind. Relax and watch your savings grow with MoneyManage!<br></h3><br><br><button id=\"start\" type=\"button\" class=\"btn btn-start\" style=\"margin:0 auto\" click.delegate=\"start()\">START</button></div></nav><br></template>"; });
...
define('text!expenses/expenses.html', ['module'], function(module) { module.exports = "<template><link rel=\"stylesheet\" href=\"https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css\"><br><br><div id=\"expenses1\"><form submit.delegate=\"next()\"><div class=\"container\" style=\"width:60%;padding:0\"><div class=\"panel-group popout\" id=\"accordion\"><compose view-model=\"./compose/compose-home-expenses\"></compose><compose view-model=\"./compose/compose-car-expenses\"></compose><compose view-model=\"./compose/compose-health-expenses\"></compose><compose view-model=\"./compose/compose-discretionary-expenses\"></compose></div></div><div id=\"personalinfo\"><hr><button class=\"btn btn-default btn-lg\" style=\"float:left;width:10vmax;margin:1vw\" click.delegate=\"back()\"><span class=\"glyphicon glyphicon-arrow-left\"></span></button> <button class=\"btn btn-primary btn-lg\" style=\"float:right;width:10vmax;margin:1vw\" type=\"submit\" id=\"next\"><span class=\"glyphicon glyphicon-arrow-right\"></span></button></div></form></div><br><br><br></template>"; });
define('text!css/style.css', ['module'], function(module) { module.exports = "#nothing{\n    animation: fadein .5s;\n    -moz-animation: fadein .5s; /* Firefox */\n    -webkit-animation: fadein .5s; /* Safari and Chrome */\n    -o-animation: fadein .5s; /* Opera */\n}\n@keyframes fadein {\n    from {\n        opacity:0;\n    }\n    to {\n        opacity:1;\n    }\n}\n@-moz-keyframes fadein { /* Firefox */\n    from {\n        opacity:0;\n    }\n    to {\n        opacity:1;\n    }\n}\n@-webkit-keyframes fadein { /* Safari and Chrome */\n    from {\n        opacity:0;\n    }\n    to {\n        opacity:1;\n    }\n}\n@-o-keyframes fadein { /* Opera */\n    from {\n        opacity:0;\n    }\n    to {\n        opacity: 1;\n    }\n}\n#personalinfo, #expenses, #results {\n    margin: 0 auto;\n    text-align: center;\n    width: 60%;\n}\n\nhtml, body {\n\tmargin:0;\n\tpadding:0;\n\theight:100%;\n\tbackground-color: #fff;\n\t    font-family: 'Maven Pro', sans-serif;\n\n}\n.range-slider {\n    /*position: relative;*/\n    height: 10px;\n}\n#app {\n\tmin-height:100%;\n\tposition:relative;\n}\n\n#content {\n\tpadding-bottom:100px; /* Height of the footer element */\n}\n\n#footer {\n\tbackground:#ededed;\n\twidth:100%;\n\theight:60px;\n\tposition:absolute;\n\tbottom:0;\n\tleft:0;\n    text-align: center;\n}\n\n.btn-sample:active {\n  color: #337ab7; \n}\n\ni {\n\twidth:10px;\n}\n\n.expensesInput {\n\twidth: 90%;\n\t margin: 0 auto;\n}\n\n.glyphicon-question-sign {\n\tcolor: #fff;\n\tfont-size: 20px;\n}\n\n.box-shadow--6dp {\nbox-shadow: 0 0 0 1px rgba(0, 0, 0, 0.1), 0 6px 9px rgba(0, 0, 0, 0.2);\n}\n\n.highcharts-series-group {\nbox-shadow: 0 0 0 1px rgba(0, 0, 0, 0.1), 0 6px 9px rgba(0, 0, 0, 0.2);\n}\n.btn{\n\tborder-radius:0;\n}\n/*.panel, .panel-group .panel-heading+.panel-collapse>.panel-body{\n    border: 0;\n}*/\n.panel-title, .panel-heading{\n  background: #337ab7 !important;\n  color:white !important;\n  font-weight:bold !important;\n  /*margin:0 !important;*/\n  padding: 1.2vmin !important;\n\n  }\n\n.adding {\n\tcolor: #3c763d;\n}\n\n.decreasing {\n\tcolor: #a94442;\n}\n.container{\n\twidth:100vw !important;\n}\n@media screen and (min-width: 700px) {\n  .container {\nwidth:85vw !important;  }\n}\n@media screen and (min-width: 1200px) {\n  .container {\nwidth:60vw !important;  }\n}\n\n#personalinfo{\n\twidth:100vw !important;\n}\n@media screen and (min-width: 700px) {\n#personalinfo {\nwidth:85vw !important;  }\n}\n@media screen and (min-width: 1200px) {\n#personalinfo {\nwidth:60vw !important;  }\n}\n\n#results{\n\twidth:100vw !important;\n}\n@media screen and (min-width: 700px) {\n#results {\nwidth:85vw !important;  }\n}\n@media screen and (min-width: 1200px) {\n#results {\nwidth:60vw !important;  }\n}\n.glyphicon.glyphicon-question-sign {\n    font-size: 70%;\n\t}\n\n.loading-bro {\n  margin: 50px auto;\n  width: 150px;\n}\n.loading-bro > h1 {\n  text-align: center;\n  font-size: 2.5em;\n  margin-bottom: 1em;\n  font-weight: 300;\n  color: #337ab7;\n}\n\n#load {\n  width: 150px;\n  animation: loading 3s linear infinite;\n}\n#load #loading-inner {\n  stroke-dashoffset: 0;\n  stroke-dasharray: 300;\n  stroke-width: 10;\n  stroke-miterlimit: 10;\n  stroke-linecap: round;\n  animation: loading-circle 2s linear infinite;\n  stroke: #337ab7;\n  fill: transparent;\n}\n\n@keyframes loading {\n  0% {\n    transform: rotate(0);\n  }\n  100% {\n    transform: rotate(360deg);\n  }\n}\n@keyframes loading-circle {\n  0% {\n    stroke-dashoffset: 0;\n  }\n  100% {\n    stroke-dashoffset: -600;\n  }\n}\n.personalInfoIntro{\n    border-radius:0; \n    /*height: 50vh; */\n    width:100%; \n    overflow:auto\n}\n@media screen and (min-width: 800px) {\n.personalInfoIntro{\n    /*height: 1vh; */\n}\n}"; });
define('text!home/home.html', ['module'], function(module) { module.exports = "<template style=\"background-color:#337ab7\"><require from=\"home/home.css\"></require><div class=\"bg\"><div style=\"position:relative;top:50%;transform:translateY(-60%)\"><div style=\"border:#fff\"><h1 id=\"title\">MoneyManage</h1><svg version=\"1.1\" baseProfile=\"tiny\" id=\"chart\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"366.037px\" height=\"261.026px\" viewBox=\"0 0 366.037 261.026\" xml:space=\"preserve\"><path fill=\"#fff\" stroke=\"#fff\" d=\"M297.813,187.789c-0.414,0-0.75-0.336-0.75-0.75V41.398c0-0.689-0.561-1.25-1.25-1.25H61.049\n\tc-0.689,0-1.25,0.561-1.25,1.25v145.641c0,0.414-0.336,0.75-0.75,0.75s-0.75-0.336-0.75-0.75V41.398c0-1.517,1.234-2.75,2.75-2.75\n\th234.764c1.516,0,2.75,1.233,2.75,2.75v145.641C298.563,187.453,298.227,187.789,297.813,187.789z M327.25,187.977\n\tc0-0.414-0.336-0.75-0.75-0.75H30.363c-0.414,0-0.75,0.336-0.75,0.75c0,10.002,8.137,18.139,18.138,18.139h261.367\n\tC319.116,206.115,327.25,197.979,327.25,187.977z M325.733,188.727c-0.394,8.828-7.696,15.889-16.615,15.889H47.75\n\tc-8.923,0-16.228-7.061-16.621-15.889H325.733z\"/><g><line class=\"dash\" fill=\"none\" stroke=\"#fff\" stroke-width=\"9\" stroke-miterlimit=\"10\" x1=\"84.662\" y1=\"168.215\" x2=\"84.662\" y2=\"140.473\"/><line class=\"dash\" fill=\"none\" stroke=\"#fff\" stroke-width=\"9\" stroke-miterlimit=\"10\" x1=\"105.592\" y1=\"168.215\" x2=\"105.592\" y2=\"149.795\"/><line class=\"dash three\" fill=\"none\" stroke=\"#fff\" stroke-width=\"9\" stroke-miterlimit=\"10\" x1=\"126.523\" y1=\"168.215\" x2=\"126.523\" y2=\"159.118\"/><line class=\"dash four\" fill=\"none\" stroke=\"#fff\" stroke-width=\"9\" stroke-miterlimit=\"10\" x1=\"147.453\" y1=\"168.215\" x2=\"147.453\" y2=\"140.473\"/><line class=\"dash five\" fill=\"none\" stroke=\"#fff\" stroke-width=\"9\" stroke-miterlimit=\"10\" x1=\"168.382\" y1=\"168.215\" x2=\"168.382\" y2=\"149.795\"/><line class=\"dash six\" fill=\"none\" stroke=\"#fff\" stroke-width=\"9\" stroke-miterlimit=\"10\" x1=\"189.313\" y1=\"168.215\" x2=\"189.313\" y2=\"140.473\"/><line class=\"dash seven\" fill=\"none\" stroke=\"#fff\" stroke-width=\"9\" stroke-miterlimit=\"10\" x1=\"210.244\" y1=\"168.215\" x2=\"210.244\" y2=\"135.812\"/><line class=\"dash eight\" fill=\"none\" stroke=\"#fff\" stroke-width=\"9\" stroke-miterlimit=\"10\" x1=\"231.173\" y1=\"168.215\" x2=\"231.173\" y2=\"163.779\"/><line class=\"dash nine\" fill=\"none\" stroke=\"#fff\" stroke-width=\"9\" stroke-miterlimit=\"10\" x1=\"252.104\" y1=\"168.215\" x2=\"252.104\" y2=\"154.457\"/><line class=\"dash ten\" fill=\"none\" stroke=\"#fff\" stroke-width=\"9\" stroke-miterlimit=\"10\" x1=\"272.201\" y1=\"168.215\" x2=\"272.201\" y2=\"163.779\"/></g><polyline fill=\"none\" points=\"84.295,72.647 104.795,97.147 147.795,75.147 189.295,110.647 231.795,102.147 270.795,122.147 \"/><polyline class=\"zigzag\" fill=\"none\" stroke=\"#337ab7\" stroke-width=\"7\" stroke-miterlimit=\"10\" points=\"84.295,72.647 104.795,97.147 \n\t147.795,75.147 189.295,110.647 231.795,102.147 270.795,122.147 \"/></svg><div style=\"text-align:center;margin:0 auto\"><a id=\"\" type=\"button\" class=\"btn btn-start\" style=\"margin:0 auto;color:#337ab7;background:#fff\" href=\"#about\"><span class=\"fa fa-info\"></span></a> <button id=\"start\" type=\"button\" class=\"btn btn-start\" style=\"margin:0 auto\" click.delegate=\"start()\">START</button></div></div></div></div></template>"; });
...
define('text!results/results.html', ['module'], function(module) { module.exports = "<template><div id=\"results\"><br><br><br><div show.bind=\"user.expenses.isTotalExpenseZero\" class=\"loading-bro\"><h1>Loading</h1><svg id=\"load\" x=\"0px\" y=\"0px\" viewBox=\"0 0 150 150\"><circle id=\"loading-inner\" cx=\"75\" cy=\"75\" r=\"60\"/></svg></div><div show.bind=\"!user.expenses.isTotalExpenseZero\"><compose view-model=\"./compose/compose-chart\"></compose><compose view-model=\"./compose/compose-recommendations\"></compose><compose show.bind=\"user.personalInfo.widthGreaterThan800\" view-model=\"./compose/compose-table\"></compose></div><hr><div show.bind=\"user.personalInfo.widthGreaterThan800\"><div show.bind=\"!user.expenses.isTotalExpenseZero\"><button class=\"btn btn-lg\" style=\"width:15vmax;background-color:#dff0d8\" click.delegate=\"getChartData()\">Redraw</button></div></div><button class=\"btn btn-default btn-lg\" style=\"float:left;width:10vmax;margin:1vw\" click.delegate=\"back()\"><span class=\"glyphicon glyphicon-arrow-left\"></span></button> <button class=\"btn btn-primary btn-lg\" style=\"float:right;width:10vmax;margin:1vw\" click.delegate=\"home()\"><span class=\"glyphicon glyphicon-remove\"></span></button><br><br><br></div></template>"; });
